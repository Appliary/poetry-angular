    ...
    */
    ...
    _findGroupChildren = function ( group, allGroups ) {
        ...
        for ( var i = 0, len = allGroups.length; i < len; i++ ) {
            ...
            if ( _group.parent && ( typeof _group.parent === "string" ? _group.parent === group.data._id : _group.parent._id === group.data._id ) ) {
            ...
            if ( _rawDataItem ) {
                ...
                if ( parent.isRoot ) {
                    ...
                    if ( _this.isAssets ) {
                        ...
                        _children = _findObj( parent, _rawData )
                            .children;
                    }
                }
