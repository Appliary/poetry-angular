app.controller( 'distributionlists/history', function ( $scope, $http ) {
    ...
    function getHistory(){
        ...
        page = 0;
        $http.get( $scope.$root.__module.api + '/' + $scope.__id + '/logs?page=' + page + '&limit=100&sort=timestamp&order=desc')
