app.controller('columnCtrl',function($scope, ngDialog, DevicesData, $q, $window){
    console.log("widget at begining of columnCtrl", $scope.widget);
    $scope.widget.isChart = true;
    $scope.widget.type = "column";
    ...
    $scope.loadData = function(){
        console.log("columnCtrl loadData toto");
    };
    ...
    angular.element($window).on('resize',function(){
        console.log("angular elem resize column");
      $scope.widget.resize=true;
    });

    $scope.$watch('widget.resize',function(){
        console.log("columnChart resize");
        $scope.isChart = false;
        setTimeout(function(){
