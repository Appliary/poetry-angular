(function () {
    ...
    function devicesSetup() {
        var directive = {
            replace: true,
            restrict: 'E',
            templateUrl: "devices/setup/device-setup.directive.html",
    ...
    deviceSetupController.$inject = [ '$scope', 'deviceService', 'iconsService' ];

    /* @ngInject */
    function deviceSetupController( $scope, deviceService, iconsService ) {
        // ***********************************************************
        //                  DECLARE VARIABLES
        var vm = this;
